...
// Task6: UART serial receiver Board B
// Upload this code to Board B. Enter a number in the range 0-10 from the serial monitor and observe the LED of this board
